...
ss.new.ETHUSDT <- fileSnapshot(path="/root/cryptoAPI/ETHUSDT/raw", file.info = T) #"/home/ubuntu/cryptoAPI/ETHUSDT/raw"
ss.new.BNBUSDT <- fileSnapshot(path="/root/cryptoAPI/BNBUSDT/raw", file.info = T)
ss.new.BTCUSDT <- fileSnapshot(path="/root/cryptoAPI/BTCUSDT/raw", file.info = T) #"/home/ubuntu/cryptoAPI/BTCUSDT/raw"
