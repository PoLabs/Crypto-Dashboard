...
pair.vector <- c('ADABTC', 'EOSBTC', 'NEOBTC', 'TRXBTC', 'XLMBTC', 'BNBBTC', 'ETHBTC', 'IOTABTC', 'BTCUSDT','ETHUSDT','BNBUSDT')
ss.new.ADABTC <- fileSnapshot(path="/root/cryptoAPI/ADABTC/raw", file.info = T) #"/home/ubuntu/cryptoAPI/BTCUSDT/raw"
ss.new.EOSBTC <- fileSnapshot(path="/root/cryptoAPI/EOSBTC/raw", file.info = T) #"/home/ubuntu/cryptoAPI/ETHUSDT/raw"
ss.new.NEOBTC <- fileSnapshot(path="/root/cryptoAPI/NEOBTC/raw", file.info = T)
ss.new.TRXBTC <- fileSnapshot(path="/root/cryptoAPI/TRXBTC/raw", file.info = T)
ss.new.XLMBTC <- fileSnapshot(path="/root/cryptoAPI/XLMBTC/raw", file.info = T)
ss.new.BNBBTC <- fileSnapshot(path="/root/cryptoAPI/BNBBTC/raw", file.info = T)
ss.new.ETHBTC <- fileSnapshot(path="/root/cryptoAPI/ETHBTC/raw", file.info = T)
ss.new.IOTABTC <- fileSnapshot(path="/root/cryptoAPI/IOTABTC/raw", file.info = T)

ss.new.BTCUSDT <- fileSnapshot(path="/root/cryptoAPI/BTCUSDT/raw", file.info = T)
ss.new.ETHUSDT <- fileSnapshot(path="/root/cryptoAPI/ETHUSDT/raw", file.info = T)
ss.new.BNBUSDT <- fileSnapshot(path="/root/cryptoAPI/BNBUSDT/raw", file.info = T)
ss.new.list <- list(ss.new.ADABTC, ss.new.EOSBTC, ss.new.NEOBTC, ss.new.TRXBTC, ss.new.XLMBTC, ss.new.BNBBTC, ss.new.ETHBTC, ss.new.IOTABTC, ss.new.BTCUSDT, ss.new.ETHUSDT, ss.new.BNBUSDT)
